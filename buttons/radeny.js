...
module.exports = {
  "name": "radeny",
    ...
    await swagballs.edit({content: "Report denied by " + interaction.member.nickname + ' :x:', components: []})
    ...
    const fchannel = await client.channels.cache.get('731984961480949762');
      ...
      fs.writeFile('/app/data/json/reports.json', JSON.stringify(reports), function (err) {if (err) throw err;});
